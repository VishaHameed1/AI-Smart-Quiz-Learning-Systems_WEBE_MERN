...
export const AuthProvider = ({ children }) => {
  ...
  const handlePostAuthRedirect = useCallback((userData, currentPath) => {
    if (!userData.onboardingCompleted) {
      if (userData.role === 'student' && currentPath !== '/role-selection') {
        // Students complete onboarding on role selection, so if they are here, it means they selected a role
        // but somehow onboardingCompleted is false. This might indicate an issue or a need to re-evaluate student onboarding.
      ...
      } else if (!userData.role && currentPath !== '/role-selection') {
        navigate('/role-selection');
      }
    } else {
      // Onboarding completed, redirect to role-specific dashboard
