...
const AdminOnboarding = () => {
  ...
  const totalSteps = 3; // Example: System Overview, User Management, Analytics Setup
        ...
        <div className="mt-8">
          {currentStep === 1 && (
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <p className="text-gray-700">Familiarize yourself with the system's architecture and key functionalities. Access global settings and configurations.</p>
              <button
          ...
          {currentStep === 2 && (
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <p className="text-gray-700">Add, edit, or remove users. Assign roles (student, teacher, admin) and manage permissions across the platform.</p>
              <button
          ...
          {currentStep === 3 && (
            <div className="bg-white p-6 rounded-lg shadow">
              <h3 className="text-xl font-semibold text-gray-800 mb-4">Step 3: Configure Analytics & Reporting</h3>
              <p className="text-gray-700">Set up global analytics dashboards and reporting tools to monitor system performance and user engagement.</p>
            </div>
          )}
